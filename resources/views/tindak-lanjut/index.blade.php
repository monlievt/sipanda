                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                            ...
                            <td class="py-3.5 px-4 text-center whitespace-nowrap">
                                <div class="inline-flex items-center gap-1.5">
                                    <a href="{{ route('tindak-lanjut.show', $group->first_id) }}" class="inline-flex items-center gap-1 px-2.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-xs shadow-xs transition-all" title="Buka Detail LHP Lengkap di Halaman Baru">
                                    ...
                                    <a href="{{ route('tindak-lanjut.export_lhp', $group->first_id) }}" class="inline-flex items-center gap-1 px-2.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl text-xs shadow-xs transition-all" title="Ekspor Matriks Tindak Lanjut LHP ini ke Excel (.xlsx)">
