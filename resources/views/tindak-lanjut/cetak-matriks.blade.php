    ...
    <div class="page-sheet max-w-6xl mx-auto bg-white p-10 sm:p-14 shadow-2xl rounded-2xl print:rounded-none border border-slate-300 print:border-none leading-relaxed">
        ...
        <div class="relative border-b-4 border-double border-slate-900 pb-3 mb-6">
            ...
            <div class="text-center px-16 sm:px-20">
                <h3 class="text-sm sm:text-base font-bold uppercase tracking-wider leading-tight text-slate-900">PEMERINTAH KABUPATEN TRENGGALEK</h3>
                <h2 class="text-lg sm:text-xl font-extrabold uppercase tracking-wide leading-tight text-slate-900 mt-0.5">INSPEKTORAT DAERAH</h2>
