    ...
    <nav class="flex-1 overflow-y-auto px-3 space-y-5 py-2 text-xs font-medium">
        ...
        <div>
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('kamus-atribut.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-all {{ request()->is('master/kamus-atribut*') ? 'bg-emerald-600 text-white font-semibold shadow-md' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                    <span>Kamus Atribut APIP</span>
                </a>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="space-y-1">
                <a href="/master/users" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-all {{ request()->is('master/users*') ? 'bg-emerald-600 text-white font-semibold shadow-md' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white' }}">
                    ...
                    <span>Kelola Pengguna Internal</span>
                </a>
                <a href="/master/opd-users" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-all {{ request()->is('master/opd-users*') ? 'bg-emerald-600 text-white font-semibold shadow-md' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    <span>Akun PIC OPD (Auditi)</span>
                </a>
                ...
                <a href="/master/kelompok-pengawasan" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-all {{ request()->is('master/kelompok-pengawasan*') ? 'bg-emerald-600 text-white font-semibold shadow-md' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                    </svg>
                    <span>Kelompok Pengawasan (ILHP)</span>
                </a>
                <a href="/master/irbans" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-all {{ request()->is('master/irbans*') ? 'bg-emerald-600 text-white font-semibold shadow-md' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
                    <span>Unit Kerja / Irban</span>
                </a>
                ...
                <a href="/master/backup" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-all {{ request()->is('master/backup*') ? 'bg-emerald-600 text-white font-semibold shadow-md' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span>Backup & Pemulihan Data</span>
                </a>
